        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            ...
            <div class="w-full">
              ...
              <p class="mt-2">
                <router-link to="/forgotpassword" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">ลืมรหัสผ่าน</router-link>
              </p>
                            <p class="mt-2">
                <router-link to="/register" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">สมัครสมาชิก</router-link>
              </p>
            </div>
          </div>
        </div>
        ...
        http.post('login',
          ...
          localStorage.setItem('user', JSON.stringify(response.data))
                ...
                Toast.fire({
                  ...
                  // เมื่อ login ผ่าน ส่งไปหน้า dashboard
